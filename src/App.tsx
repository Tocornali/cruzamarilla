...
export default function App() {
  // Configuración fija de API
  const apiKey = 'ms_live_bbd5499b466f47304b69128c6bf5c26ea21d5c9b6a9e18b014c2e77c55813190';
  const baseUrl = 'http://localhost:3000/api/v1/productos';
